...
<html lang="es">
    <head>
        ...
        <link rel="icon" href="<?= URL; ?>public/img/clover-logo-tab.ico">
    ...
    <body>
        <div class="container" id="container">
            <div class="form-container sign-in-container">
                <form class="row gx-3 allign-items-center">
                    <div class="col-auto">
            ...
            <div class="overlay-container" id="overlayCon">
                <div class="overlay">
                    <div class="overlay-panel overlay-right">
                        <img src="<?= URL; ?>public/img/dashboard.webp" alt="Transporte clover">
                    </div>
                </div>
            </div>
        </div>
